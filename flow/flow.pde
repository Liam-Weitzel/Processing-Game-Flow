...
void setup() {
 ...
 float[] level1 = {width/2.2, height-1, (width-((width/2.2)*2)), 1, 0, 0, 0, 0, width-(width/2.2), height-5, width/2.2, 5, 0, height-5, width/2.2, 5, 220, height-300, width/2, 20, width-200, height/3, 200, 20, 50, height/5, 100, 20, 0, 0, 0, 0, 0, 0, 0, 0};
...
void draw() {
  if (gamestate == 0) {
    ...
    background(255);
    fill(0, 102, 153);
    text("+1 upgrade available:", width/3, height/3-100);
    text("Teleportation size", width/3+50, height/3);
    rect(width/3, height/3-25, 30,30, 7);
    fill(255);
    rect(width/3+3, height/3-25+12, 24, 5, 7);
    rect(width/3+12, height/3-25+3, 5,24, 7);
    fill(0, 102, 153);
    text("Teleportation cooldown", width/3+50, height/3+70);
    rect(width/3, height/3+45, 30,30, 7);
    fill(255);
    rect(width/3+3, height/3+45+12, 24, 5, 7);
    rect(width/3+12, height/3+45+3, 5,24, 7);
    fill(0, 102, 153);
    text("Player speed", width/3+50, height/3+140);
    rect(width/3, height/3+115, 30,30, 7);
    fill(255);
    rect(width/3+3, height/3+115+12, 24, 5, 7);
    rect(width/3+12, height/3+115+3, 5,24, 7);
    fill(0, 102, 153);
    text("Jump height", width/3+50, height/3+210);
    rect(width/3, height/3+185, 30,30, 7);
    fill(255);
    rect(width/3+3, height/3+185+12, 24, 5, 7);
    rect(width/3+12, height/3+185+3, 5,24, 7);
    fill(0, 102, 153);
  }
}
...
void mouseClicked() {
  if (gamestate == 1 && mouseX >= width/2-75 && mouseX <= width/2-75+150 && mouseY >= height/2+height/6 && mouseY <= height/2+height/6+80) {
    gamestate = 0;
  } else if (gamestate == 2 && mouseX >= width/3 && mouseX <= width/3+30 && mouseY >= height/3-25 && mouseY <= height/3-25+30) {
    gamestate = 0; //tp size
    maxtpsize = maxtpsize + 150;
  } else if (gamestate == 2 && mouseX >= width/3 && mouseX <= width/3+30 && mouseY >= height/3+45 && mouseY <= height/3+45+30) {
    gamestate = 0; //tp cd
    tpincrement = tpincrement + 8;
  } else if (gamestate == 2 && mouseX >= width/3 && mouseX <= width/3+30 && mouseY >= height/3+115 && mouseY <= height/3+115+30) {
    gamestate = 0; //player speed
    playerspeed = playerspeed + 1;
  } else if (gamestate == 2 && mouseX >= width/3 && mouseX <= width/3+30 && mouseY >= height/3+185 && mouseY <= height/3+185+30) {
    gamestate = 0; //jump height
...
void levelcheck() {
  ...
  if (grounded(finish) == true && currlevelint == 1) {
    ...
    resetrockets();
    resetexplosions();
  } else if (grounded(finish) == true && currlevelint == 3) {
    gamestate = 2; //upgrade available
    
    float[] level4 = {width/2.2, height-1, (width-((width/2.2)*2)), 1, width/2.2, height-5, (width-((width/2.2)*2)), 5, width-(width/2.2), height-5, width/2.2, 5, 0, height-5, width/2.2, 5, 0, height/3, width/7, 20, width/7+30, height/3+175, width/7-10, 20, width/7+30+width/7+30, height/3+175+175, width/3-10, 20, width/7+30+width/7+30+width/3+30, height/3+175, width/7-10, 20, width-width/7, height/3, width/7, 20};
    int[] level4turrets = {100, 0, 0, 1, 0, width-100, 0, 0, 1, 0};
    int[] level4buttons = {90,height/3-10,10,10, 110,height/3-10,10,10, width-120,height/3-10,10,10, width-100,height/3-10,10,10};
    
    arrayCopy(level4, staticlevel);
    currlevel = level4;
    arrayCopy(level4buttons, staticbuttons);
    currlevelbuttons = level4buttons;
    currlevelturrets = level4turrets;
    currlevelint = 4;
